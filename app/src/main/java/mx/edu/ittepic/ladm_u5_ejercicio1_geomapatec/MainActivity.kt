...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button2.setOnClickListener {
            var res=""
            baseRemota.collection("tecnologico")
                .whereEqualTo("nombre", editText.text.toString())
                .addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                    if (firebaseFirestoreException != null) {
                         res="NO HAY CONEXION"
                        return@addSnapshotListener
                    ...
                    for (document in querySnapshot!!) {
                        res += "\nNombre: " + document.getString("nombre") +
                                "\nCOORDENADAS :\n" + document.getGeoPoint("posicion1") +"\na\n"+ document.getGeoPoint("posicion2")
    ...
    private fun miUbicacion() {
        ...
        //FORMA DE OBTENER UBICACION GPS
        LocationServices.getFusedLocationProviderClient(this).lastLocation
            .addOnSuccessListener {
                ...
                for (item in posicion){
                    if(item.estoyEn(geoPosicion)==true){
                        AlertDialog.Builder(this).setMessage("USTED SE ENCUENTRA EN :${item.nombre}")
                            .setTitle("ATENCION")
            ...
            .addOnFailureListener {
                textView2.setText("ERROR AL NO TENER UBICACION")
            }
    }
    ...
    override fun onLocationChanged(location: Location) {
       ...
       // p.textView3.setText("")
        ...
        for (item in p.posicion){
            if(item.estoyEn(geoPosicionGPS)==true){
